...
module.exports = {
  ...
  siteDomain: "blog-bruno-orozcos-projects.vercel.app",
  siteLocale: "es-MX",
  ...
  baseUrl:
    ...
    process.env.NEXT_PUBLIC_VERCEL_ENV !== "production" && process.env.NEXT_PUBLIC_VERCEL_URL !== undefined
      ...
      : "https://blog-bruno-orozcos-projects.vercel.app", // fallback to production URL
  onionDomain: "http://blog-bruno-orozcos-projects.vercel.app",
  ...
  webmentionId: "blog-bruno-orozcos-projects.vercel.app",
  githubRepo: "bruno-orozco/blog",
  giscusConfig: {
